        ...
        <div class="row justify-content-md-center">
            <div class="col-md-6">
                ...
                {% else %}
                    ...
                    {% embed "snipplets/forms/form.tpl" with{form_id: 'newpass-form', submit_custom_class: 'd-block m-auto', submit_text: (customer.password ? 'Cambiar contraseña' : 'Activar cuenta')  | translate } %}
                        {% block form_body %}
