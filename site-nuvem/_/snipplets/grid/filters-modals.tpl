			...
			<div class="category-controls-row row">
				{% if products %}
					<div class="col col-md-auto category-control-item">
						...
						{% embed "snipplets/modal.tpl" with{modal_id: 'sort-by', modal_class: 'sort-by modal-docked-small', modal_position: 'left', modal_position_desktop: right, modal_width: 'docked-md', modal_transition: 'slide', modal_header_title: true} %}
							{% block modal_head %}
				...
				{% if has_filters_available %}
					<div class="visible-when-content-ready col col-md-auto pl-md-2 category-control-item">
						...
						{% embed "snipplets/modal.tpl" with{modal_id: 'nav-filters', modal_class: 'filters modal-docked-small', modal_position: 'right', modal_position_desktop: right, modal_transition: 'slide', modal_header_title: true, modal_width: 'docked-md' } %}
							{% block modal_head %}
								{{'Filtrar ' | translate }}
							{% endblock %}
							{% block modal_body %}
								{% if has_filters_available %}
									{{ component(
										'filters/remove-filters',{
											container_classes: {
												filters_container: "filters-properties-container",
											},
											filter_classes: {
									...
									{{ component(
										'filters/filters',{
											...
											filter_classes: {
												...
												list_title: "h6 mb-3 font-weight-bold",
												...
												price_title: 'h6 font-weight-bold mb-3',
