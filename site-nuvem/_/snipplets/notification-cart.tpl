{% set notification_without_recommendations_classes = 'js-alert-added-to-cart notification-floating notification-cart-container notification-hidden notification-fixed' %}
{% set notification_wrapper_classes = 
    related_products ? 'row' 
    : not related_products and add_to_cart_fixed ? notification_without_recommendations_classes ~ ' position-fixed-md' 
