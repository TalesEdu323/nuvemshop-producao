{% set stack_item_quantity = stack_item_quantity | default(false) %}

<div class="{% if item_quantity %}col-12 mb-1 {% if not stack_item_quantity %}col-md-5 mb-md-0{% endif %}{% else %}col-4{% if template == 'product' %} col-md-3{% endif %}{% endif %}">
    {% embed "snipplets/forms/form-input.tpl" with{
    type_number: true, input_value: '1',
    input_name: 'quantity' ~ item.id, 
    input_custom_class: 'js-quantity-input form-control', 
    input_label: false, 
    ...
    {% endembed %}
    {% if settings.product_stock and not item_quantity %}
