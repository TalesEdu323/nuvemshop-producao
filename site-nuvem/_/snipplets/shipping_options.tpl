{% if options %}
    ...
    {% if store.show_shipping_emergency_message %}
        <div class="alert alert-warning mb-3 font-small">{{ store.shipping_emergency_message }}</div> 
    {% endif %}
    ...
    {% if has_featured_shipping %}
        ...
        <div class="font-small font-weight-bold mb-2">
            {{ "Envío a domicilio" | translate }}
        </div>

        <ul class="list-unstyled list-container full-width-container {% if not has_non_featured_shipping and has_featured_pickup %}mb-2{% endif %}">
            ...
            {% if has_non_featured_shipping %}
                ...
                <div class="js-other-shipping-options float-left shipping-extra-options full-width-container w-100" style="display: none;">
        ...
        {% if has_non_featured_shipping %}
            <div class="js-toggle-more-shipping-options js-show-more-shipping-options full-width-container mt-1 text-center {% if has_featured_pickup %}full-width-container mb-2{% endif %}">
                <a href="#" class="btn-link btn-block full-width-container">
    ...
    {% if has_featured_pickup %}
        ...
        <ul class="list-unstyled list-container full-width-container">
            ...
            {% if has_non_featured_pickup %}
                ...
                <div class="js-other-pickup-options shipping-extra-options full-width-container" style="display: none;">
        ...
        {% if has_non_featured_pickup %}
            <div class="js-toggle-more-shipping-options js-show-other-pickup-options full-width-container text-center">
                <a href="#" class="btn-link btn-block full-width-container">
                    <span class="js-shipping-see-more">
    ...
    {% if store.has_smart_dates and show_time %}
        <div class="full-width-container mt-3">{{ 'El tiempo de entrega <strong>no considera feriados</strong>.' | translate }}</div>
    {% endif %}
    <div class="js-product-shipping-label mt-2 w-100" style="display: none;">
        <span class="js-shipping-filled-cart js-visible-on-cart-filled" {% if cart.items_count == 0 %}style="display:none;"{% endif %}>
            <svg class="icon-inline mr-2"><use xlink:href="#info-circle"/></svg>
